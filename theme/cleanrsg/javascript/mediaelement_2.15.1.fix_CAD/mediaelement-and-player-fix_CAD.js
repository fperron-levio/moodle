...
// version number
mejs.version = '2.15.1.fix_cad'; 

// CAD FIX. DEBUT.
// Le mécanisme de localisation de mediaelement pose problème. L'initialisation se fait trop tôt (sauf si on utilise la langue au niveau du navigateur).
// Le fix est donc Ã  deux niveau:
// 1. Ajout de la table de string fr (voir plus loin dans le fichier). Existe dans les sources mais pas dans le build (il faudrait idéalement faire le rebuild "clean" (et avoir la version minifié).
// 2. Utilisation d'un "hack" (mejsL10n) déjÃ  prévu pour Wordpress pour définir la langue (implémenté ici):
// ATTENTION: Ce correctif est utilisé au niveau du thème (plate-forme) et au niveau des capsules.
mejsL10n = {};
mejsL10n.language = 'fr';
// CAD FIX. FIN.
...
// CAD FIX. DEBUT.
// FICHIER MANQUANT DANS LE BUILD PAR DÉFAUT DE MEDIAELEMENT.
/*!
 * This is a i18n.locale language object.
 *
